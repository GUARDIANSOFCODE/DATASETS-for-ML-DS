...
if 'player_df' in globals() and 'team_df' in globals():
    ...
    player_df['DOB'] = pd.to_datetime(player_df['DOB'], errors='coerce')
    ...
    players_by_team = player_df['Country'].value_counts()
    players_by_team.plot(kind='bar', color='skyblue', edgecolor='black')
